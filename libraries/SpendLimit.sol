...
contract SpendLimit is Base {
    ...
    function setSpendingLimit(address _token, uint _amount) public onlyOwnerOrSelf {
    ...
    function removeSpendingLimit(address _token) public onlyOwnerOrSelf {
